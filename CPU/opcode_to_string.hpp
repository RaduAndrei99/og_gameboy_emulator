...
// Base instruction names for opcodes 0x00 - 0xFF
inline const std::array<std::string, 256> opcodeTable = {
    ...
    "RET C","RETI","JP C,a16","","CALL C,a16","PUSH HL","SBC A,d8","RST 18H",
    "LD (a8),A","POP HL","LD (C),A","","","PUSH HL","AND d8","RST 20H",
    "ADD SP,r8","JP (HL)","LD (a16),A","","","PUSH AF","XOR d8","RST 28H",
    "LD A,(a8)","POP AF","LD A,(C)","DI","","PUSH AF","OR d8","RST 30H",
    "LD HL,SP+r8","LD SP,HL","LD A,(a16)","EI","","","CP d8","RST 38H"
};

// CB-prefixed instructions 0x00 - 0xFF
inline const std::array<std::string, 256> cbOpcodeTable = {
